...
public class GameMap {
	...
	public GameMap() {
		...
		//	构造地图结构
//        /*0*/theRooms.add(new Room("城堡外",null,"英俊的小偷头目",
...
//				10,6,3,2,"女仆被你推倒了！"));
//        /*5*/theRooms.add(new Room("二楼睡房", null,"公主的管家",
//				300,20,5,25,"管家扑街、公主被你推倒了！"));
//        /*6*/theRooms.add(new Room("负一楼", null, "奇怪的男人",
//				200,30,15,25,"男人身边站出来一名浑身是伤的女孩。。"));
//        /*7*/theRooms.add(new Room("负二楼",null,"穿着霸气的绅士",
//				100,50,35,35,"绅士的衣服脏了！"));
//        /*8*/theRooms.add(new Room("负三楼",null,"身穿铠甲的战士",
//				300,30,25,45,"战士被自己绊倒了！"));
//        /*9*/theRooms.add(new Room("负四楼",null,"持剑的骑士",
//				400,40,35,60,"骑士的剑断了！"));
//        /*10*/theRooms.add(new Room("三楼阳台"));
//        /*11*/theRooms.add(new Room("城堡顶部瞭望塔",null, "瞭望塔守卫",
//				150, 20, 2, 20, "守卫倒下了！"));
//        /*12*/theRooms.add(new Room("羊肠小道", null,"街边小混混",
//				100,30,1,20 ,null));
//        /*13*/theRooms.add(new Room("日出村大门","欢迎来到城堡西边的日出村！", "和善的门卫",
//				150,20,20,30 ,"门卫露出了和善的笑容"));
//        /*14*/theRooms.add(new Room("神秘空间祭坛",null,"冰封",
//				1000,150,100,200,"冰封认真地写着客户端。。。"));
//        /*15*/theRooms.add(new Room("神秘空间西",null,"无",
//				1000,150,100,200,"无认真地写这服务器端。。。"));
//        /*16*/theRooms.add(new Room("神秘空间东",null,"奶茶",
//				1000,150,100,200,"奶茶去复习考试了。。。"));
//        /*17*/theRooms.add(new Room("神秘空间北",null,"果冻",
...
//        /*20*/theRooms.add(new Room("神秘的井", null,"打水的熊孩子",
//				50, 10, 1, 5, "熊孩子掉头就跑。"));
